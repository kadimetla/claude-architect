...
Reference: `private/claude-cookbooks-main/tool_use/tool_use_with_pydantic.ipynb`.
...
Cost is roughly **3x baseline** but catches systematic biases that a single pass cannot detect. Reference: `private/claude-cookbooks-main/patterns/agents/evaluator_optimizer.ipynb`.
...
- `private/claude-cookbooks-main/tool_use/` - full tool-use cookbook
- `private/claude-cookbooks-main/patterns/agents/` - agent design patterns
